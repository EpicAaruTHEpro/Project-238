...
# login method, has error with sql injection
...
# method to get address on profile page
...
# address to add the order on orders
...
# lets user submit help, but allows file types that are not secure
...
# method to let user search for a particular order, has bug that lets user find other user login credentials
